...
[![Build Status](https://travis-ci.org/gundy/weather.svg?branch=master)](https://travis-ci.org/gundy/weather) 
[![StyleCI build status](https://github.styleci.io/repos/144818004/shield)](https://github.styleci.io/repos/144818004)

## 安装

```sh
$ composer require gundy/weather -vvv
```
...
可以用两种方式来获取 `Gundy\Weather\Weather` 实例：
